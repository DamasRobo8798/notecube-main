...
public class Robot extends TimedRobot {
  ...
   */
  CANSparkBase m_leftWheel = new CANSparkMax(5, MotorType.kBrushed);
  CANSparkBase m_rightWheel = new CANSparkMax(6, MotorType.kBrushed);
 ...
 /**
  ...
   */
  static final double LAUNCHER_AMP_SPEED = 1.0;
  /**
  ...
  public void robotInit() {
    ...
     */
    m_leftWheel.setSmartCurrentLimit(FEEDER_CURRENT_LIMIT_A);
    m_rightWheel.setSmartCurrentLimit(LAUNCHER_CURRENT_LIMIT_A);
  ...
  public void autonomousPeriodic() {
    ...
    {
      m_rightWheel.set(AUTO_LAUNCHER_SPEED);
  ...
  public void teleopPeriodic() {
    ...
    if (m_driverController.getRawButton(3)) {
      //m_rightWheel.set(LAUNCHER_SPEED);
      //m_leftWheel.set(LAUNCHER_SPEED);
    }
    ...
    {
      m_rightWheel.set(FEEDER_OUT_SPEED);
      m_leftWheel.set(FEEDER_OUT_SPEED);
    }
    ...
    {
      m_rightWheel.set(0.3); // HIZI AYARLANIYOR
      m_leftWheel.set(0.3);
    }
    ...
    {
      m_leftWheel.set(FEEDER_AMP_SPEED); // HIZI AYARLANIYOR
      m_rightWheel.set(LAUNCHER_AMP_SPEED);
    }
